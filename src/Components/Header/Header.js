...
const Header = () => {
    return (
       <div className='lg:grid lg:grid-cols-2 border style h-full p-4 m-5'>
       ...
       <img src='https://i.postimg.cc/y6DjJQ13/img4.jpg' alt="" className='rounded-md w-full h-80 p-3' />
        ...
        <div className='p-3 m-2 h-80 text'>
            ...
            <p className='text-xl bg-slate-200 p-5 my-3 w-10/12 mx-auto'>All of the students are attend the quiz exam and get 100000 taka.</p>
