...
const Blog = () => {
    return (
        <div className='my-5 p-10 bg-slate-200 lg:w-10/12 mx-auto'>
            <h2 className='text-3xl text-blue-600 font-bold mb-8'>React Router Question And Answer</h2>
            <div className='bg-purple-300 lg:w-9/12 mx-auto p-10'>
            ...
            <div className='bg-blue-300 lg:w-9/12  mx-auto my-5 p-10'>
            ...
            <div className='bg-green-300 lg:w-9/12  mx-auto my-5 p-10'>
